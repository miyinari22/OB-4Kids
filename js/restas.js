// Generar una pregunta de restas con números aleatorios
function generateQuestion() {
    ...
    // Asegurarse de que num1 siempre sea mayor o igual a num2
    ...
    while (options.size < 4) {
        ...
        // Asegurarse de que las respuestas incorrectas no sean negativas ni iguales a la correcta
